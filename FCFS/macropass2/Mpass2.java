...
public class Mpass2 {
	...
	public static void main(String[] args) throws IOException {
		...
		int macro_addr = -1;
	 	...
	 	BufferedReader br1=new BufferedReader(new FileReader("SPOS/src/macropass2/MNT.txt"));
	 	String line;
		...
		br1=new BufferedReader(new FileReader("SPOS/src/macropass2/argmnt.txt"));
	 	while((line = br1.readLine())!=null)
	 	{
		...
		br1=new BufferedReader(new FileReader("SPOS/src/macropass2/MDT.txt"));
	 	while((line = br1.readLine())!=null)
	 	{
	 		MDT[mdt_cnt]=new mdt();
		...
		br1=new BufferedReader(new FileReader("SPOS/src/macropass2/input4.txt"));
		arglist[] actual_parameter=new arglist[10];
		
		BufferedWriter bw1 = new BufferedWriter(new FileWriter("SPOS/src/macropass2/output4.txt"));
	 	while((line = br1.readLine())!=null)
	 	{
