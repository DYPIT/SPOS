...
public class MPass1 {
	public static void main(String[] args) throws IOException {
		...
		BufferedReader br1=new BufferedReader(new FileReader("SPOS/src/macropass1/input3.txt"));
	 	String line;
	 	mdt[] MDT=new mdt[20];
	 	mnt[] MNT=new mnt[4];
	 	...
	 	br1.close();
	 		// We have to change this path
	 	BufferedWriter bw1=new BufferedWriter(new FileWriter("SPOS/src/macropass1/input3.txt"));
	 	System.out.println("\n\t********MACRO NAME TABLE**********");
		System.out.println("\n\tINDEX\tNAME\tADDRESS");
		...
		bw1.close();
			// We have to change this path
		bw1=new BufferedWriter(new FileWriter("SPOS/src/macropass1/ARGLIST.txt"));
		System.out.println("\n\n\t********ARGUMENT LIST**********");
		System.out.println("\n\tINDEX\tNAME\tADDRESS");
		...
		System.out.println("\n\tINDEX\t\tSTATEMENT");
			// We have to change this path
		bw1=new BufferedWriter(new FileWriter("SPOS/src/macropass1/MDT.txt"));
