...
public class pass2 {
	public static void main(String[] Args) throws IOException{
		 BufferedReader b1 = new BufferedReader(new FileReader("SPOS/src/assemblerpass2/intermediate.txt"));
	     BufferedReader b2 = new BufferedReader(new FileReader("SPOS/src/assemblerpass2/littab.txt"));
	     BufferedReader b3 = new BufferedReader(new FileReader("SPOS/src/assemblerpass2/symtab.txt"));
	     FileWriter f1 = new FileWriter("SPOS/src/assemblerpass2/pass2.txt");
